...
<div class="container-fluid">
  <div class="row">
    <div class="d-flex justify-content-end align-items-center w-100 p-3" style="background: #222;">
      <span class="text-white me-3">{username}</span>
      <a class="btn btn-danger btn-sm" href="/logout">Logout</a>
    </div>
    <!-- Sidebar -->
    <nav
      class="col-md-3 col-lg-2 d-md-block bg-dark sidebar py-4"
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <h1 class="mb-4 mt-4">After Hours</h1>
      <table class="table table-dark table-hover rounded over">
        <thead>
          <tr>
            <th>#</th>
            <th>Title</th>
